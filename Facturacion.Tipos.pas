...
const
  ...
  _NOMBRE_PUBLICO_GENERAL               = 'PUBLICO';
  _APELLIDOS_PUBLICO_GENERAL            = 'EN GENERAL';
  _NOMBRE_CONTRIBUYENTE_PUBLICO_GENERAL = _NOMBRE_PUBLICO_GENERAL + ' ' + _APELLIDOS_PUBLICO_GENERAL;
  _NOMBRE_EXTRANJERO                    = 'VENTA';
  _APELLIDOS_EXTRANJERO                 = 'AL EXTRANJERO';
  _NOMBRE_CONTRIBUYENTE_EXTRANJERO      = _NOMBRE_EXTRANJERO + ' ' + _APELLIDOS_EXTRANJERO;
  _UUID_LONGITUD                        = 36;
