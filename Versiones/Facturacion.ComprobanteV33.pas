...
{ IXMLComprobante }
  ...
  IXMLComprobante = interface(IXMLNode)
    ...
    function Get_CfdiRelacionados: IXMLComprobante_CfdiRelacionados;
    ...
    property CfdiRelacionados: IXMLComprobante_CfdiRelacionados read Get_CfdiRelacionados;
...
function TXMLComprobante.Get_CfdiRelacionados: IXMLComprobante_CfdiRelacionados;
begin
  Result := ChildNodes['CfdiRelacionados'] as IXMLComprobante_CfdiRelacionados;
end;
